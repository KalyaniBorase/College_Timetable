...
<script src="js/bootstrap.min.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"><font color="#FF0000">Our Shadule</font></a>
    </div>
...
<header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <a href="./admin/index.php" class="btn btn-primary btn-xl page-scroll">Find Out</a>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12 text-center">
                        <h2 class="section-heading">About Time Table</h2>
                        <hr class="primary">
                    </div>
